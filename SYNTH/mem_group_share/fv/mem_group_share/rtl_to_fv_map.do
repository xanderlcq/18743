...
# Generated on: Sat Apr 23 16:24:36 EDT 2022 (Sat Apr 23 20:24:36 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/mem_group_share/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mem_group_share -revised fv_map
...
read_design -enumconstraint  -define RISING -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/mem_group_share.sv src/mem.sv
elaborate_design -golden -root {mem_group_share} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mem_group_share/fv_map.v.gz
elaborate_design -revised -root {mem_group_share}
...
#add_name_alias fv/mem_group_share/fv_map.singlebit.original_name.alias.json.gz -revised
