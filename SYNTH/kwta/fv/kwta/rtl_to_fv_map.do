...
# Generated on: Sun Apr 03 20:50:12 EDT 2022 (Mon Apr 04 00:50:12 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/kwta/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/kwta -revised fv_map
...
read_design -enumconstraint  -define RISING -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/kwta.sv
elaborate_design -golden -root {kwta} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/kwta/fv_map.v.gz
elaborate_design -revised -root {kwta}
...
#add_name_alias fv/kwta/fv_map.singlebit.original_name.alias.json.gz -revised
