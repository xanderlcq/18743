...
# Generated on: Mon Apr 25 12:06:15 EDT 2022 (Mon Apr 25 16:06:15 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/mux_b_t_s/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mux_b_t_s -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/mux_b_t_s.sv
elaborate_design -golden -root {mux_b_t_s} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mux_b_t_s/fv_map.v.gz
elaborate_design -revised -root {mux_b_t_s}
