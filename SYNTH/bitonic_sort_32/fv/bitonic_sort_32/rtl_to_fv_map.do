...
# Generated on: Tue Mar 29 15:02:07 EDT 2022 (Tue Mar 29 19:02:07 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/bitonic_sort_32/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/bitonic_sort_32 -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/bitonic.sv
elaborate_design -golden -root {bitonic_sort_32} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/bitonic_sort_32/fv_map.v.gz
elaborate_design -revised -root {bitonic_sort_32}
