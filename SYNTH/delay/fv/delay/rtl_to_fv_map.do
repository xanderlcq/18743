...
# Generated on: Sat Apr 23 15:49:15 EDT 2022 (Sat Apr 23 19:49:15 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/delay/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/delay -revised fv_map
...
read_design -enumconstraint  -define RISING -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/delay.sv
elaborate_design -golden -root {delay} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/delay/fv_map.v.gz
elaborate_design -revised -root {delay}
...
#add_name_alias fv/delay/fv_map.singlebit.original_name.alias.json.gz -revised
