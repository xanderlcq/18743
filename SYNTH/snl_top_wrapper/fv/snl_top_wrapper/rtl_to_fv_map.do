...
# Generated on: Tue Mar 29 15:07:56 EDT 2022 (Tue Mar 29 19:07:56 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/snl_top_wrapper/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/snl_top_wrapper -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/neuron_snl_grl.sv
elaborate_design -golden -root {snl_top_wrapper} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/snl_top_wrapper/fv_map.v.gz
elaborate_design -revised -root {snl_top_wrapper}
