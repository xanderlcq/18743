...
module neuron_snl_grl ( output_spike, input_spikes, input_weights );
  ...
  bitonic_sort_32 up ( .sorted_out({SYNOPSYS_UNCONNECTED_1, 
        SYNOPSYS_UNCONNECTED_2, SYNOPSYS_UNCONNECTED_3, SYNOPSYS_UNCONNECTED_4, 
        SYNOPSYS_UNCONNECTED_5, SYNOPSYS_UNCONNECTED_6, SYNOPSYS_UNCONNECTED_7, 
        SYNOPSYS_UNCONNECTED_8, SYNOPSYS_UNCONNECTED_9, 
        SYNOPSYS_UNCONNECTED_10, output_spike, SYNOPSYS_UNCONNECTED_11, 
        ...
        SYNOPSYS_UNCONNECTED_30, SYNOPSYS_UNCONNECTED_31}), .raw_in(up_times)
         );
  OR2_X1 U1 ( .A1(input_spikes[1]), .A2(input_weights[17]), .ZN(up_times[9])
         );
  OR2_X1 U2 ( .A1(input_spikes[1]), .A2(input_weights[16]), .ZN(up_times[8])
         );
  OR2_X1 U3 ( .A1(input_spikes[0]), .A2(input_weights[31]), .ZN(up_times[7])
         );
  OR2_X1 U4 ( .A1(input_spikes[0]), .A2(input_weights[30]), .ZN(up_times[6])
         );
  OR2_X1 U5 ( .A1(input_spikes[0]), .A2(input_weights[29]), .ZN(up_times[5])
         );
  OR2_X1 U6 ( .A1(input_spikes[0]), .A2(input_weights[28]), .ZN(up_times[4])
         );
  OR2_X1 U7 ( .A1(input_spikes[0]), .A2(input_weights[27]), .ZN(up_times[3])
         );
  OR2_X1 U8 ( .A1(input_spikes[3]), .A2(input_weights[7]), .ZN(up_times[31])
         );
  OR2_X1 U9 ( .A1(input_spikes[3]), .A2(input_weights[6]), .ZN(up_times[30])
         );
  OR2_X1 U10 ( .A1(input_spikes[0]), .A2(input_weights[26]), .ZN(up_times[2])
         );
  OR2_X1 U11 ( .A1(input_spikes[3]), .A2(input_weights[5]), .ZN(up_times[29])
         );
  OR2_X1 U12 ( .A1(input_spikes[3]), .A2(input_weights[4]), .ZN(up_times[28])
         );
  OR2_X1 U13 ( .A1(input_spikes[3]), .A2(input_weights[3]), .ZN(up_times[27])
         );
  OR2_X1 U14 ( .A1(input_spikes[3]), .A2(input_weights[2]), .ZN(up_times[26])
         );
  OR2_X1 U15 ( .A1(input_spikes[3]), .A2(input_weights[1]), .ZN(up_times[25])
         );
  OR2_X1 U16 ( .A1(input_spikes[3]), .A2(input_weights[0]), .ZN(up_times[24])
         );
  OR2_X1 U17 ( .A1(input_spikes[2]), .A2(input_weights[15]), .ZN(up_times[23])
         );
  OR2_X1 U18 ( .A1(input_spikes[2]), .A2(input_weights[14]), .ZN(up_times[22])
         );
  OR2_X1 U19 ( .A1(input_spikes[2]), .A2(input_weights[13]), .ZN(up_times[21])
         );
  OR2_X1 U20 ( .A1(input_spikes[2]), .A2(input_weights[12]), .ZN(up_times[20])
         );
  OR2_X1 U21 ( .A1(input_spikes[0]), .A2(input_weights[25]), .ZN(up_times[1])
         );
  OR2_X1 U22 ( .A1(input_spikes[2]), .A2(input_weights[11]), .ZN(up_times[19])
         );
  OR2_X1 U23 ( .A1(input_spikes[2]), .A2(input_weights[10]), .ZN(up_times[18])
         );
  OR2_X1 U24 ( .A1(input_spikes[2]), .A2(input_weights[9]), .ZN(up_times[17])
         );
  OR2_X1 U25 ( .A1(input_spikes[2]), .A2(input_weights[8]), .ZN(up_times[16])
         );
  OR2_X1 U26 ( .A1(input_spikes[1]), .A2(input_weights[23]), .ZN(up_times[15])
         );
  OR2_X1 U27 ( .A1(input_spikes[1]), .A2(input_weights[22]), .ZN(up_times[14])
         );
  OR2_X1 U28 ( .A1(input_spikes[1]), .A2(input_weights[21]), .ZN(up_times[13])
         );
  OR2_X1 U29 ( .A1(input_spikes[1]), .A2(input_weights[20]), .ZN(up_times[12])
         );
  OR2_X1 U30 ( .A1(input_spikes[1]), .A2(input_weights[19]), .ZN(up_times[11])
         );
  OR2_X1 U31 ( .A1(input_spikes[1]), .A2(input_weights[18]), .ZN(up_times[10])
         );
  OR2_X1 U32 ( .A1(input_spikes[0]), .A2(input_weights[24]), .ZN(up_times[0])
         );
endmodule


module snl_top_wrapper ( clk, clk_out, output_spike, input_spikes, 
        input_weights );
  input [0:3] input_spikes;
  input [31:0] input_weights;
  input clk;
  output clk_out, output_spike;


  neuron_snl_grl nsg ( .output_spike(output_spike), .input_spikes(input_spikes), .input_weights(input_weights) );
  BUF_X1 U1 ( .A(clk), .Z(clk_out) );
endmodule
