...
# Generated on: Tue Apr 26 14:50:52 EDT 2022 (Tue Apr 26 18:50:52 UTC 2022)
...
set_log_file fv/mux_b_t_t_1/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mux_b_t_t_1 -revised fv_map
...
read_design -enumconstraint -define RISING -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  src/mux_b_t_t_1.sv
elaborate_design -golden -root {mux_b_t_t_1} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mux_b_t_t_1/fv_map.v.gz
elaborate_design -revised -root {mux_b_t_t_1}
...
#add_name_alias fv/mux_b_t_t_1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/mux_b_t_t_1/rtl_to_fv_map.log
}
