...
# Generated on: Tue Mar 29 15:10:01 EDT 2022 (Tue Mar 29 19:10:01 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/kwta_no_tie_break/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/kwta_no_tie_break -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/kwta_no_tie_break.sv
elaborate_design -golden -root {kwta_no_tie_break} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/kwta_no_tie_break/fv_map.v.gz
elaborate_design -revised -root {kwta_no_tie_break}
...
add_black_box sr_latch less_than_eq -golden
