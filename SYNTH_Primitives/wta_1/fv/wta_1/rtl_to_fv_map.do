...
# Generated on: Sun Apr 03 17:53:18 EDT 2022 (Sun Apr 03 21:53:18 GMT 2022)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/wta_1/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/wta_1 -revised fv_map
...
read_design -enumconstraint  -define RISING -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 src/wta_1.sv
elaborate_design -golden -root {wta_1} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/wta_1/fv_map.v.gz
elaborate_design -revised -root {wta_1}
...
add_black_box less_than_eq -golden
